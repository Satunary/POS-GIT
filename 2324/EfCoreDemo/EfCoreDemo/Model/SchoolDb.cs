...
namespace EfCoreDemoV2.Model
{
    ...
    public class SchoolDb : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string dbPath = Path.Combine(FileSystem.AppDataDirectory, "exams.db3");
            optionsBuilder
            ...
            var pupils = new Faker<Student>().CustomInstantiator(f =>
            {
                ...
                return new Student(
                    ...
                    dateOfBirth: f.Date.Between(
                                  new DateTime(2010 - int.Parse(schoolclass.Name.Substring(0, 1)), 9, 1),
                                  new DateTime(2011 - int.Parse(schoolclass.Name.Substring(0, 1)), 9, 1)).Date);
